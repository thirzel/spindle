...
// Data functions for table code_invivo
...
function code_invivo_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `code_chrev_scenes` where `invivo_code`='".addslashes($id[0])."'", $eo);
...
function code_invivo_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#invivo').replaceWith('<p class=\"form-control-static\" id=\"invivo\">' + (jQuery('#invivo').val() || '') + '</p>');\n";
		$jsReadOnly .= "\tjQuery('#start_date').replaceWith('<p class=\"form-control-static\" id=\"start_date\">' + (jQuery('#start_date').val() || '') + '</p>');\n";
		$jsReadOnly .= "\tjQuery('#end_date').replaceWith('<p class=\"form-control-static\" id=\"end_date\">' + (jQuery('#end_date').val() || '') + '</p>');\n";
		$jsReadOnly .= "\tjQuery('#person').replaceWith('<p class=\"form-control-static\" id=\"person\">' + (jQuery('#person').val() || '') + '</p>');\n";
		$jsReadOnly .= "\tjQuery('#place').replaceWith('<p class=\"form-control-static\" id=\"place\">' + (jQuery('#place').val() || '') + '</p>');\n";
