<?php
	...
	*/
	 ...
	 *     $data['story'], $data['agent'], $data['story_character'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['character_element'], $data['character_elem_value'], $data['comment']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['agent'], $data['story_character'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['character_element'], $data['character_elem_value'], $data['comment']
