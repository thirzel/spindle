<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_trascript' table. 
	...
	*/
	...
	function biblio_trascript_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function biblio_trascript_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function biblio_trascript_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['author'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits']
	...
	*/
	...
	function biblio_trascript_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['author'], $data['author_memberID'], $data['bibliography_id'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits']
	...
	*/
	...
	function biblio_trascript_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits']
	...
	*/
	...
	function biblio_trascript_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['author_memberID'], $data['bibliography_id'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits']
	...
	*/
	...
	function biblio_trascript_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_trascript_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function biblio_trascript_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function biblio_trascript_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function biblio_trascript_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function biblio_trascript_batch_actions(&$args){
